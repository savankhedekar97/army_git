    ...
    >
      <div className="constitution-overlay">
        <div className="constitution-container animate-constitution">
          ...
          <p className="subtitle">View or Download the full Constitution Document easily and securely.</p>
          <div className="buttons">
            <a href="/assets/documents/constitution.pdf" target="_blank" rel="noopener noreferrer" className="btn-view">
              View Constitution
            </a>
            <a href="/assets/documents/constitution.pdf" download className="btn-download">
